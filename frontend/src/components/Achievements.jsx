  ...
  return (
    <section id="achievements" className="py-28 bg-dark-900 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[28rem] h-[28rem] bg-violet-500/8 rounded-full blur-3xl" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {achievements.map((item, index) => (
            <motion.div
              ...
              className="glass rounded-xl p-6 group hover:shadow-[0_0_30px_rgba(124,58,237,0.18)] transition-shadow duration-300"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <h3 className="text-base font-bold text-white group-hover:text-violet-300 transition-colors duration-200 truncate">
                      {item.title}
                    </h3>
